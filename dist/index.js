...
var g = class extends (globalThis.HTMLElement ?? HTMLElementShimWithRealType) {
  ...
  static getPropertyDescriptor(t4, s4, i3) {
    const { get: e4, set: r7 } = o2(this.prototype, t4) ?? { get() {
      return this[s4];
    }, set(t5) {
      this[s4] = t5;
    } };
  ...
  requestUpdate(t4, s4, i3, e4 = false, r7) {
    if (void 0 !== t4) {
      if (i3 ??= this.constructor.getPropertyOptions(t4), !(i3.hasChanged ?? y)(e4 ? r7 : this[t4], s4))
        return;
      this.C(t4, s4, i3);
    }
...
var P = (t4, i3) => {
  ...
  for (let i4 = 0; i4 < s4; i4++) {
    ...
    for (; y3 < s5.length && (c4.lastIndex = y3, u3 = c4.exec(s5), null !== u3); )
      y3 = c4.lastIndex, c4 === f2 ? "!--" === u3[1] ? c4 = v : void 0 !== u3[1] ? c4 = _ : void 0 !== u3[2] ? ($.test(u3[2]) && (r7 = RegExp("</" + u3[2], "g")), c4 = m2) : void 0 !== u3[3] && (c4 = m2) : c4 === m2 ? ">" === u3[0] ? (c4 = r7 ?? f2, d3 = -1) : void 0 === u3[1] ? d3 = -2 : (d3 = c4.lastIndex - u3[2].length, a3 = u3[1], c4 = void 0 === u3[3] ? m2 : '"' === u3[3] ? g2 : p2) : c4 === g2 || c4 === p2 ? c4 = m2 : c4 === v || c4 === _ ? c4 = f2 : (c4 = m2, r7 = void 0);
...
var S2 = class {
  ...
  u(t4) {
    const { el: { content: i3 }, parts: s4 } = this._$AD, e4 = ((t4 == null ? void 0 : t4.creationScope) ?? r3).importNode(i3, true);
    E.currentNode = e4;
...
var M = class _M {
  ...
  constructor(t4, i3, s4, e4) {
    this.type = 2, this._$AH = w, this._$AN = void 0, this._$AA = t4, this._$AB = i3, this._$AM = s4, this.options = e4, this._$Cv = (e4 == null ? void 0 : e4.isConnected) ?? true;
  }
  get parentNode() {
  ...
  _$AI(t4, i3 = this, s4, e4) {
    ...
    if (void 0 === h3)
      ...
      for (t4 = h3[0], n5 = 0; n5 < h3.length - 1; n5++)
        r7 = N(this, e5[s4 + n5], i3, n5), r7 === b2 && (r7 = this._$AH[n5]), o5 ||= !c3(r7) || r7 !== this._$AH[n5], r7 === w ? t4 = w : t4 !== w && (t4 += (r7 ?? "") + h3[n5 + 1]), this._$AH[n5] = r7;
    }
    o5 && !e4 && this.O(t4);
  }
  O(t4) {
...
var Z = (t4, i3, s4) => {
  const e4 = (s4 == null ? void 0 : s4.renderBefore) ?? i3;
  let h3 = e4._$litPart$;
  if (void 0 === h3) {
    const t5 = (s4 == null ? void 0 : s4.renderBefore) ?? null;
