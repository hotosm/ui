import{registerIconLibrary as t}from"@shoelace-style/shoelace/dist/utilities/icon-library.js";var l={list:`
  ...
  `},e=i=>i in l?`data:image/svg+xml,${encodeURIComponent(l[i])}`:"";function s(){t("hot-icons",{resolver:e})}var r=s;export{r as a};
