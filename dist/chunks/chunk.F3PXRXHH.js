import{a as h}from"./chunk.HFXH7BZT.js";import{a as m}from"./chunk.WPXUR5EI.js";import{a as i,b as a,c as r,d as c}from"./chunk.FWYUHKRF.js";import"@shoelace-style/shoelace/dist/components/alert/alert.js";import{LitElement as y,html as v}from"lit";import{property as l}from"lit/decorators.js";m();var g,f,w,b,t=class extends y{constructor(){super(...arguments);this.name="hot-tracking";r(this,g,"");r(this,f,"");r(this,w,!1);r(this,b,!0)}get siteId(){return a(this,g)}set siteId(e){c(this,g,e)}get domain(){return a(this,f)}set domain(e){c(this,f,e)}get force(){return a(this,w)}set force(e){c(this,w,e)}get isOpen(){return a(this,b)}set isOpen(e){c(this,b,e)}render(){return v`<sl-alert class="tracking" variant="danger" ?open=${this.isOpen}>
      <sl-icon
        id="hot-red-text"
        library="bundled"
        slot="icon"
